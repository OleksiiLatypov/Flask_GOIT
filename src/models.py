...
class User(db.Model):
    ...
    hash = db.Column(db.String(150), nullable=True)
    token_cookie = db.Column(db.String(150), nullable=True, default=None)
...
class Picture(db.Model):
    ...
    def __repr__(self):
        return f'Pictures({self.id}, {self.path}, {self.size})'
